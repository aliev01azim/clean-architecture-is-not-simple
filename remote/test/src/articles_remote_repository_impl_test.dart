...
import 'package:remote/src/auth_remote_repository_impl.dart';
...
@GenerateMocks([AuthService, ArticlesEntityMapper])
void main() {
  late AuthService articlesService;
  late ArticlesEntityMapper articlesEntityMapper;
  late AuthRemoteRepositoryImpliclesRemoteRepositoryImpl;

  setUp(() {
    articlesService = MockArticlesService();
    articlesEntityMapper = MockArticlesEntityMapper();

    articlesRemoteRepositoryImpl = AuthRemoteRepositoryImpl
